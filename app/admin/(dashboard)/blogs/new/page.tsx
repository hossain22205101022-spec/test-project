...
export const metadata = {
  title: "Admin - Write Blog | StyleFeed",
};
  ...
  return (
    <div className="space-y-5 w-full pb-12">
      <div className="flex items-center justify-between gap-4 bg-white border border-gray-100 rounded-2xl shadow-sm px-5 py-4">
        ...
        {/* Right: badge */}
        <div className="flex-shrink-0 hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-50 border border-gray-100 text-xs font-medium text-gray-500">

...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data: blog } = await supabase.from('blogs').select('title, content').eq('slug', slug).single();

 if (!blog) { return { title: 'Not Found | StyleFeed' }; }

  return {
    title: `${blog.title} | StyleFeed Blog`,
   ...
   <div className='min-h-screen bg-white'>
     <div className='max-w-4xl mx-auto px-4 pt-10 lg:pt-16 pb-24'>
       ...
       <div className='flex flex-col items-center text-center mb-10'>
         ...
         <div className='flex flex-wrap justify-center items-center gap-6 text-gray-500 text-sm font-medium mt-2'>
       ...
       <div className='flex flex-col lg:flex-row gap-12'>
         ...
         <div className='hidden lg:flex flex-col w-12 flex-shrink-0'>
           <div className='sticky top-32 flex flex-col gap-4 items-center'>
             <span className='text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 whitespace-nowrap mt-8'>SHARE</span>
